package com.project.automationqa.utilities;
...
public class Utilities {
    ...
    public static final String GLOBAL_FILE_PATH = "./src/main/resources/config.properties";
    public static final String SECRETS_FILE_PATH = "./src/main/resources/secrets.properties";
    ...
    public static void initGlobalConfiguration() {
        ...
        try (FileInputStream input = new FileInputStream(GLOBAL_FILE_PATH)) {
            prop.load(input);
            IMPLICIT_WAIT_TIME = Integer.parseInt(prop.getProperty("implicit.timeout", "5"));
            EXPLICIT_WAIT_TIME = Integer.parseInt(prop.getProperty("explicit.timeout", "5"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
